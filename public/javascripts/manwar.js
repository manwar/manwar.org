...
$("#pr_2026").click(function() {
    $('#pr-spinner').show();
    $.ajax({
        url: "/pullrequest/2026",
        dataType: "JSON",
        success: function(data) {
            $('#pr_2026_stats').highcharts(data);
        },
        complete: function() {
            $('#pr-spinner').hide();
        }
...
$("#pr_2025").click(function() {
    $('#pr-spinner').show();
    $.ajax({
        url: "/pullrequest/2025",
        dataType: "JSON",
        success: function(data) {
            $('#pr_2025_stats').highcharts(data);
        },
        complete: function() {
            $('#pr-spinner').hide();
        }
...
$("#pr_2024").click(function() {
    $('#pr-spinner').show();
    $.ajax({
        url: "/pullrequest/2024",
        dataType: "JSON",
        success: function(data) {
            $('#pr_2024_stats').highcharts(data);
        },
        complete: function() {
            $('#pr-spinner').hide();
        }
...
$("#gc_2026").click(function() {
    $('#gc-spinner').show();
    $.ajax({
        url: "/git-commits/2026",
        dataType: "JSON",
        success: function(data) {
            $('#gc_2026_stats').highcharts(data);
        },
        complete: function() {
            $('#gc-spinner').hide();
        }
...
$("#gc_2025").click(function() {
    $('#gc-spinner').show();
    $.ajax({
        url: "/git-commits/2025",
        dataType: "JSON",
        success: function(data) {
            $('#gc_2025_stats').highcharts(data);
        },
        complete: function() {
            $('#gc-spinner').hide();
        }
...
$("#gc_2024").click(function() {
    $('#gc-spinner').show();
    $.ajax({
        url: "/git-commits/2024",
        dataType: "JSON",
        success: function(data) {
            $('#gc_2024_stats').highcharts(data);
        },
        complete: function() {
            $('#gc-spinner').hide();
        }
